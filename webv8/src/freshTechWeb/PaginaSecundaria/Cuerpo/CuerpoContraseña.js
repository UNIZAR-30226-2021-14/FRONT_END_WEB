...
const validate = values =>{
  ...
  if (!values.fecha_caducidad || !/[0-9][0-9]\-[0-9][0-9]\-[0-9][0-9][0-9][0-9]/.test(values.fecha_caducidad)||!verificarFecha(values.fecha_caducidad)){
...
class CuerpoContraseña extends React.Component {
  ...
  selectContrasenyasName=async(value)=>{
    ...
    .then(response =>{
      ...
      this.setState({listadoContrasenyas:lista,cargaContenido:false});
    })
  ...
  render () {
    ...
    return (
      ...
      <>
        ...
        <li class="collection-header ml-4"><h4><strong>Contraseñas</strong></h4></li>
        {this.state.listadoContrasenyas.map(data=>(
          <li key={data.nombre} class="collection-item avatar">
