  ...
  render () {
    ...
    return (
      ...
      <div className="passwdMeter">
          ...
          <div className="meter">
            <br/>
            <input autoComplete="off" type="password" onChange={e => this.setState({ password: e.target.value,copied1:false})} />
            ...
            <br/>
            <br/>
            <input autoComplete="off" type="text" onChange={e => this.setState({ contrasenya_avanzado: e.target.value,copied2:false})} readOnly="readonly" value={this.state.contrasenya_avanzado}/>
