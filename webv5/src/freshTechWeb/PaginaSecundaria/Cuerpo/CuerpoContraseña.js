...
class CuerpoContraseña extends React.Component {
  ...
  actualizarContrasenya=async(value1,value2)=>{
    ...
    const datos = {nombrePassword:this.state.nombre,concreteuser:this.state.usuario,concretepasswd:this.state.contrasenya, dominio:this.state.url,fechacreacion:this.state.fecha_actual,fechacaducidad:this.state.fecha_caducidad,nombre:this.state.nombre,categoria:value1};
              ...
              <Popup
                ...
                cuerpo = {
                  ...
                  <div className="meter1">
                    ...
                    <strong>Genere una contraseña</strong>
                    <br/>
