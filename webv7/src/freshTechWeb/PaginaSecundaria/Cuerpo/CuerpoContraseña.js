...
class CuerpoContraseña extends React.Component {
  ...
  crearContrasenya=async(value)=>{
    ...
    const datos = {concreteuser:this.state.usuario,concretepasswd:this.state.contrasenya, dominio:this.state.url,fechacreacion:this.state.fecha_actual,fechacaducidad:this.state.fecha_caducidad,nombre:this.state.nombre,categoria:this.state.categoria};
  ...
  selectContrasenyasName=async(value)=>{
    ...
    const config = {
      ...
      params:{ordenarPor:orden,ordenarDe:this.state.ordenarDe}
    }
    ...
    .then(response =>{
      ...
      this.setState({listadoContrasenyas:response.data,cargaContenido:false});
    })
    ...
    return (
      ...
      <>
        ...
        <div className="contenido">
          ...
          <pre key={data.nombre}>
            <label htmlFor={data.nombre} className="contrasenyasGestion">
              ...
              <input name={data.nombre} id={data.nombre} type='button' value='Eliminar' onClick={this.delete}/>
            </label>
          </pre>
          ))}   
        </div>
            ...
            {errors.nombre && <p className="warning">{errors.nombre}</p>}*/}
                ...
                {errors.fecha_caducidad && <p className="warning">{errors.fecha_caducidad}</p>}*/} 
                  ...
                  <div className="input-field">
                    ...
                    <input className="field2" type="date" name="fecha_actual"id="fecha_actual" value={"Fecha creación: " +this.state.fecha_actual} onChange={this.handleChange} readOnly/>
                    {errors.fecha_actual && <p className="warning">{errors.fecha_actual}</p>}
                  </div>
               ...
               <div className="input-field ">
                ...
                <div className="input-field">
                  ...
                  <div className="input-field">
                    ...
                    <input className="field2" ref={this.creacion} type="date" name="fecha_actual"id="fecha_actual" value={"Fecha creación: " + this.state.fecha_actual} onChange={this.handleChange} readOnly/>
                    {errors.fecha_actual && <p className="warning">{errors.fecha_actual}</p>}
                  </div>
                ...
                cuerpo = {
                  ...
                  <div className="meter1">
                    ...
                    <div className="botones">
                      <label>
                        <input  class="with-gap" id="input1" name="radio" type="radio"  onChange={this.generarContrasenyaDebil}/>
                        <span className="checkFont">Numeros</span> 
                      </label>
                      <br></br>
                      <label>
                        <input  class="with-gap" id="input2" name="radio" type="radio" onChange={this.generarContrasenyaMedia}/>
                        <span className="checkFont">Numeros y letras</span>
                      </label>
                      <br></br>
                      <label>
                        <input  class="with-gap" id="input3" name="radio" type="radio" onChange={this.generarContrasenyaFuerte}/>
                    ...
                    <input type='submit' class="btn waves-effect waves-light mr-5" value='Guardar' onClick={this.comprobarPasswd}/>
                    <input type='button' class="btn waves-effect waves-light" value='cancelar' onClick={this.togglePopup4.bind(this)}/>
